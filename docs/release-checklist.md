...
- `/board/portfolio` shows integration readiness, portfolio risk summary, agency setup-code controls, agency staff invite/status controls for agency admins, and scoped portfolio/operations CSV exports.
