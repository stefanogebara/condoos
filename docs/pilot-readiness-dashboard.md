...
- Agency portfolio foundation: agency records, agency/building links, agency memberships, `/api/agencies/portfolio`, `/board/portfolio` risk summary, agency selector, private setup-code management, and portfolio CSV export.
...
- Management-company portfolio mode is still early. Agency admins can manage private activation codes and export portfolio metrics, but staff assignment UI and deeper cross-building exports still need hardening.
...
- Incident mode.
- Portfolio dashboard is not yet a full agency command center: agency setup-code controls and portfolio CSV export exist, but agency staff invite UI, permissions review screens, and deeper operational exports are still pending.
