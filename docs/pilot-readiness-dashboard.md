...
- Ticket timeline events, SLA escalation rules, vendor quote comparison, quote selection/rejection decisions, recurring maintenance risk detection, and vendor follow-up health are real. Remaining maintenance hardening is more polished multi-building maintenance summaries.
...
The next buyer-visible upgrade should package the already-real maintenance workflow into stronger agency reporting: richer multi-building maintenance summaries and a walkthrough-ready work-order story.
