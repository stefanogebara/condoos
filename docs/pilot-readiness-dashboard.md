...
- Ticket timeline events, SLA escalation rules, vendor quote comparison, quote selection/rejection decisions, and recurring maintenance risk detection are real. Remaining maintenance hardening is richer vendor follow-up reporting and more polished multi-building maintenance summaries.
...
The next buyer-visible upgrade should package the already-real maintenance workflow into stronger agency reporting: vendor follow-up health, richer multi-building maintenance summaries, and a walkthrough-ready work-order story.
