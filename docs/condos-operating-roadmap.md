...
- Show a cross-building escalation view for urgent tickets, missed vendor SLAs, stale vendor follow-ups, and recurring maintenance clusters, with the same audited owner/date/status controls.
