...
- Add agency records, portfolio metrics, private setup-code controls with activation tracking, staff email invites, scoped staff building assignments, assigned-building switching, and scoped portfolio/operations CSV exports above existing building workflows.
