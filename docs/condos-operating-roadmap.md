...
4. **Maintenance as work orders**
   - Ticket timeline events, quote comparison, quote decisions, recurring problem detection, vendor follow-up health, SLA alerts, resident-safe progress visibility, executive report snapshots, and per-building monthly maintenance/finance scoreboards are in place.
   - Remaining work: PDF report packaging, trend charts, and richer visual multi-building maintenance sections.
