...
4. **Maintenance as work orders**
   - Ticket timeline events, quote comparison, quote decisions, recurring problem detection, SLA alerts, and resident-safe progress visibility are in place.
   - Remaining work: richer vendor follow-up health and multi-building maintenance summaries.
