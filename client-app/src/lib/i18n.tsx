...
const phrases: Copy[] = [
  ...
  c('A votação só abre quando custo, análise, riscos e janela estiverem claros.', 'Voting only opens when cost, analysis, risks, and the voting window are clear.', 'La votación solo se abre cuando costo, análisis, riesgos y plazo están claros.', 'Le vote ne s’ouvre que lorsque le coût, l’analyse, les risques et la fenêtre sont clairs.'),
