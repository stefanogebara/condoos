...
const phrases: Copy[] = [
  ...
  c('Dia a dia', 'Daily', 'Día a día', 'Au quotidien'),
  c('Atualizamos o app. Recarregue para continuar.', 'We updated the app. Reload to continue.', 'Actualizamos la app. Recarga para continuar.', 'Nous avons mis à jour l’app. Rechargez pour continuer.'),
  c('Recarregar', 'Reload', 'Recargar', 'Recharger'),
  c('Plano IA', 'AI plan', 'Plan IA', 'Plan IA'),
  c('Plano com diagnóstico — abra "Detalhes do plano"', 'Plan with diagnostics — open "Plan details"', 'Plan con diagnóstico — abre "Detalles del plan"', 'Plan avec diagnostic — ouvrir « Détails du plan »'),
  c('Plano gerado com IA', 'AI-generated plan', 'Plan generado con IA', 'Plan généré par IA'),
  c('Buscar na memória do prédio', 'Search the building memory', 'Buscar en la memoria del edificio', 'Rechercher dans la mémoire de l’immeuble'),
  c('orçamento de elevador', 'elevator quote', 'presupuesto de ascensor', 'devis d’ascenseur'),
  c('manutenção mensal', 'monthly maintenance', 'mantenimiento mensual', 'maintenance mensuelle'),
  c('última assembleia', 'latest assembly', 'última asamblea', 'dernière assemblée'),
  c('seguro do prédio', 'building insurance', 'seguro del edificio', 'assurance immeuble'),
  c('Ver todos os', 'See all', 'Ver todos los', 'Voir tous les'),
  ...
  c('Entre direto no seu prédio', 'Go straight to your building', 'Entra directo a tu edificio', 'Accédez directement à votre immeuble'),
  ...
  c('Prontidão para votação', 'Voting readiness', 'Preparación para votación', 'Préparation au vote'),
  c('A votação só abre quando custo, análise, riscos e janela estiverem claros.', 'Voting only opens when cost, analysis, risks, and the voting window are clear.', 'La votación solo se abre cuando costo, análisis, riesgos y plazo quedan claros.', 'Le vote ne s’ouvre que lorsque le coût, l’analyse, les risques et la fenêtre sont clairs.'),
  c('Complete a prontidão antes de abrir a votação.', 'Complete readiness before opening voting.', 'Completa la preparación antes de abrir la votación.', 'Complétez la préparation avant d’ouvrir le vote.'),
  c('Prontidão atualizada', 'Readiness updated', 'Preparación actualizada', 'Préparation mise à jour'),
  c('Falha ao salvar prontidão', 'Failed to save readiness', 'Error al guardar la preparación', 'Échec de l’enregistrement de la préparation'),
  c('Salvar prontidão', 'Save readiness', 'Guardar preparación', 'Enregistrer la préparation'),
  c('Custo estimado', 'Estimated cost', 'Costo estimado', 'Coût estimé'),
  c('Base do orçamento', 'Budget basis', 'Base del presupuesto', 'Base du budget'),
  c('Riscos, impacto e alternativas', 'Risks, impact, and alternatives', 'Riesgos, impacto y alternativas', 'Risques, impact et alternatives'),
  c('Cole a cotação, itens principais ou explique por que não há custo direto.', 'Paste the quote, main line items, or explain why there is no direct cost.', 'Pega la cotización, partidas principales o explica por qué no hay costo directo.', 'Collez le devis, les principaux postes ou expliquez pourquoi il n’y a pas de coût direct.'),
  c('Explique impacto nos moradores, dependências, riscos e alternativas mais baratas se existirem.', 'Explain resident impact, dependencies, risks, and cheaper alternatives if they exist.', 'Explica el impacto en residentes, dependencias, riesgos y alternativas más baratas si existen.', 'Expliquez l’impact résident, les dépendances, les risques et les alternatives moins chères s’il y en a.'),
  c('Clear scope', 'Clear scope', 'Alcance claro', 'Périmètre clair'),
  c('Budget', 'Budget', 'Presupuesto', 'Budget'),
  c('Cost analysis', 'Cost analysis', 'Análisis de costos', 'Analyse des coûts'),
  c('Risks and impact', 'Risks and impact', 'Riesgos e impacto', 'Risques et impact'),
  c('Voting window', 'Voting window', 'Plazo de votación', 'Fenêtre de vote'),
  c('Add a clear title and enough description for residents to understand what will change.', 'Add a clear title and enough description for residents to understand what will change.', 'Agrega un título claro y suficiente descripción para que los residentes entiendan qué cambiará.', 'Ajoutez un titre clair et assez de description pour que les résidents comprennent ce qui changera.'),
  c('Add an estimated cost, or 0 when the proposal has no direct expense.', 'Add an estimated cost, or 0 when the proposal has no direct expense.', 'Agrega un costo estimado, o 0 si la propuesta no tiene gasto directo.', 'Ajoutez un coût estimé, ou 0 si la proposition n’a pas de dépense directe.'),
  c('Explain the budget, quote basis, or why there is no direct cost.', 'Explain the budget, quote basis, or why there is no direct cost.', 'Explica el presupuesto, la base de la cotización o por qué no hay costo directo.', 'Expliquez le budget, la base du devis ou pourquoi il n’y a pas de coût direct.'),
  c('Summarize resident impact, operational risks, dependencies, or cheaper alternatives.', 'Summarize resident impact, operational risks, dependencies, or cheaper alternatives.', 'Resume el impacto en residentes, riesgos operativos, dependencias o alternativas más baratas.', 'Résumez l’impact résident, les risques opérationnels, les dépendances ou les alternatives moins chères.'),
  c('Set a future voting closing date so the decision has a clear deadline.', 'Set a future voting closing date so the decision has a clear deadline.', 'Define una fecha futura de cierre para que la decisión tenga un plazo claro.', 'Définissez une date future de clôture afin que la décision ait une échéance claire.'),
  ...
  c('Não foi possível carregar os moradores', 'Could not load residents', 'No se pudieron cargar los residentes', 'Impossible de charger les résidents'),
  ...
  c('Use Nova proposta para iniciar a primeira discussão formal do prédio.', 'Use New proposal to start the building’s first formal discussion.', 'Usa Nueva propuesta para iniciar la primera discusión formal del edificio.', 'Utilisez Nouvelle proposition pour lancer la première discussion formelle de l’immeuble.'),
  c('Nenhum morador cadastrado ainda.', 'No residents registered yet.', 'Aún no hay residentes registrados.', 'Aucun résident enregistré pour le moment.'),
  c('Importe um CSV ou compartilhe o código de convite para começar a montar a base do prédio.', 'Import a CSV or share the invite code to start building the resident base.', 'Importa un CSV o comparte el código de invitación para empezar a crear la base del edificio.', 'Importez un CSV ou partagez le code d’invitation pour commencer à constituer la base résidents.'),
  ...
  c('+ comentar', '+ comment', '+ comentar', '+ commenter'),
  c('Vote nestes', 'Vote on these', 'Vota estos', 'Votez sur ceux-ci'),
  c('Em andamento', 'In progress', 'En curso', 'En cours'),
  c('Comente seu voto (opcional, ajuda o síndico a decidir)', 'Comment on your vote (optional, helps the board decide)', 'Comenta tu voto (opcional, ayuda al administrador a decidir)', 'Commentez votre vote (facultatif, aide le syndic à décider)'),
  c('ex: Vi o problema ontem às 18h, no andar 3', 'e.g. I saw the issue yesterday at 6pm, on floor 3', 'ej.: Vi el problema ayer a las 18:00, en el piso 3', 'ex. J’ai vu le problème hier à 18 h, au 3e étage'),
  c('Enviar voto com comentário', 'Send vote with comment', 'Enviar voto con comentario', 'Envoyer le vote avec commentaire'),
  c('Voto registrado: confirmo', 'Vote recorded: confirm', 'Voto registrado: confirmo', 'Vote enregistré : je confirme'),
  c('Voto registrado: não confirmo', 'Vote recorded: I do not confirm', 'Voto registrado: no confirmo', 'Vote enregistré : je ne confirme pas'),
  c('Falha ao registrar voto', 'Failed to record vote', 'Error al registrar voto', 'Échec de l’enregistrement du vote'),
  c('Agente analisando', 'Agent analyzing', 'Agente analizando', 'Agent en analyse'),
  c('fornecedor concluiu (aguarda síndico)', 'vendor completed (awaiting board)', 'proveedor concluyó (esperando administrador)', 'prestataire terminé (en attente du syndic)'),
  ...
  c('Retornos', 'Follow-up', 'Seguimiento', 'Suivi'),
  ...
  c('Retorno fornecedor', 'Vendor follow-up', 'Seguimiento proveedor', 'Suivi prestataire'),
  ...
  c('Ver', 'View', 'Ver', 'Voir'),
  c('Escalações', 'Escalations', 'Escalaciones', 'Escalades'),
  c('Problemas que travam a operação', 'Problems blocking operations', 'Problemas que traban la operación', 'Problèmes qui bloquent les opérations'),
  c('Chamados urgentes, SLA perdido e fornecedores sem retorno em todos os prédios permitidos.', 'Urgent tickets, missed SLAs, and vendors with no response across every allowed building.', 'Tickets urgentes, SLA incumplidos y proveedores sin respuesta en todos los edificios permitidos.', 'Tickets urgents, SLA manqués et prestataires sans réponse dans tous les immeubles autorisés.'),
  c('críticos', 'critical', 'críticos', 'critiques'),
  c('acompanhamentos atrasados', 'overdue follow-ups', 'seguimientos atrasados', 'suivis en retard'),
  c('30+ dias', '30+ days', '30+ días', '30+ jours'),
  c('7-29 dias', '7-29 days', '7-29 días', '7-29 jours'),
  c('Novo', 'New', 'Nuevo', 'Nouveau'),
  c('Sem data', 'No date', 'Sin fecha', 'Sans date'),
  c('Filtrar escalações', 'Filter escalations', 'Filtrar escalaciones', 'Filtrer les escalades'),
  c('Críticos', 'Critical', 'Críticos', 'Critiques'),
  c('Sem dono', 'Unowned', 'Sin responsable', 'Sans responsable'),
  c('Fornecedor/SLA', 'Vendor/SLA', 'Proveedor/SLA', 'Prestataire/SLA'),
  c('Recorrentes', 'Recurring', 'Recurrentes', 'Récurrents'),
  c('Nenhuma escalação operacional agora.', 'No operational escalation right now.', 'No hay escalaciones operativas ahora.', 'Aucune escalade opérationnelle pour le moment.'),
  c('Nenhuma escalação neste filtro.', 'No escalation in this filter.', 'No hay escalaciones en este filtro.', 'Aucune escalade dans ce filtre.'),
  c('Abrir', 'Open', 'Abrir', 'Ouvrir'),
  c('Mostrando as 8 escalações mais importantes. Use os cartões dos prédios para ver todos os registros.', 'Showing the 8 most important escalations. Use the building cards to see every record.', 'Mostrando las 8 escalaciones más importantes. Usa las tarjetas de edificios para ver todos los registros.', 'Affichage des 8 escalades les plus importantes. Utilisez les cartes des immeubles pour voir tous les registres.'),
  c('Scorecard de fornecedores', 'Vendor scorecard', 'Scorecard de proveedores', 'Scorecard fournisseurs'),
  c('Inteligência de fornecedores', 'Vendor intelligence', 'Inteligencia de proveedores', 'Intelligence fournisseurs'),
  c('Fornecedores atrasados, sem atualização e ativos em todos os prédios permitidos.', 'Late, stale, and active vendor work across every allowed building.', 'Proveedores atrasados, sin actualización y activos en todos los edificios permitidos.', 'Prestataires en retard, sans mise à jour et actifs dans tous les immeubles autorisés.'),
  c('Nenhum fornecedor com ordens de serviço no portfólio ainda.', 'No vendor has portfolio work orders yet.', 'Aún no hay proveedores con órdenes de servicio en el portafolio.', 'Aucun prestataire avec des ordres de service dans le portefeuille pour le moment.'),
  c('prédios', 'buildings', 'edificios', 'immeubles'),
  c('atrasado', 'late', 'atrasado', 'en retard'),
  c('atrasados', 'late', 'atrasados', 'en retard'),
  c('sem atualização', 'stale', 'sin actualización', 'sans mise à jour'),
  c('Ativas', 'Active', 'Activas', 'Actives'),
  c('Concluídas', 'Completed', 'Concluidas', 'Terminées'),
  c('Gasto aprovado', 'Approved spend', 'Gasto aprobado', 'Dépense approuvée'),
  c('Última atividade', 'Last activity', 'Última actividad', 'Dernière activité'),
  c('Atrasos', 'Overdues', 'Atrasos', 'Retards'),
  c('Saúde operacional', 'Operational health', 'Salud operativa', 'Santé opérationnelle'),
  c('Saudável', 'Healthy', 'Saludable', 'Sain'),
  c('Em observação', 'Watch', 'En observación', 'À surveiller'),
  c('Crítico', 'Critical', 'Crítico', 'Critique'),
  c('Comunidade', 'Community', 'Comunidad', 'Communauté'),
  c('Próximas ações', 'Next actions', 'Próximas acciones', 'Prochaines actions'),
  c('Registros que explicam o risco', 'Records explaining risk', 'Registros que explican el riesgo', 'Registres expliquant le risque'),
  c('Abrir lista', 'Open list', 'Abrir lista', 'Ouvrir la liste'),
  c('Sem registros recentes.', 'No recent records.', 'Sin registros recientes.', 'Aucun registre récent.'),
  c('Sem acompanhamento', 'No follow-up', 'Sin seguimiento', 'Aucun suivi'),
  c('Responsável atual', 'Current owner', 'Responsable actual', 'Responsable actuel'),
  c('Sem responsável', 'No owner', 'Sin responsable', 'Sans responsable'),
  c('Sem prazo', 'No due date', 'Sin plazo', 'Sans échéance'),
  c('Estado', 'Status', 'Estado', 'Statut'),
  c('Aguardando', 'Waiting', 'Esperando', 'En attente'),
  c('Concluído', 'Done', 'Concluido', 'Terminé'),
  c('Nota', 'Note', 'Nota', 'Note'),
  c('Próximo passo, ligação ou decisão esperada', 'Next step, call, or expected decision', 'Próximo paso, llamada o decisión esperada', 'Prochaine étape, appel ou décision attendue'),
  c('Salvar acompanhamento', 'Save follow-up', 'Guardar seguimiento', 'Enregistrer le suivi'),
  c('Não foi possível salvar o acompanhamento.', 'Could not save the follow-up.', 'No se pudo guardar el seguimiento.', 'Impossible d’enregistrer le suivi.'),
  c('Acompanhamentos', 'Follow-ups', 'Seguimientos', 'Suivis'),
  c('Riscos com dono e prazo para acompanhar esta semana.', 'Risks with an owner and due date to chase this week.', 'Riesgos con responsable y plazo para dar seguimiento esta semana.', 'Risques avec responsable et échéance à suivre cette semaine.'),
  c('Sem acompanhamentos abertos.', 'No open follow-ups.', 'No hay seguimientos abiertos.', 'Aucun suivi ouvert.'),
  c('Atrasado', 'Overdue', 'Atrasado', 'En retard'),
  c('Atrasados', 'Overdue', 'Atrasados', 'En retard'),
  c('Abertos', 'Open', 'Abiertos', 'Ouverts'),
  c('Filtrar acompanhamentos por estado', 'Filter follow-ups by status', 'Filtrar seguimientos por estado', 'Filtrer les suivis par statut'),
  c('Filtrar acompanhamentos por prédio', 'Filter follow-ups by building', 'Filtrar seguimientos por edificio', 'Filtrer les suivis par immeuble'),
  c('Nenhum acompanhamento corresponde aos filtros.', 'No follow-up matches the filters.', 'Ningún seguimiento coincide con los filtros.', 'Aucun suivi ne correspond aux filtres.'),
  c('Mostrando os 8 acompanhamentos mais urgentes. Ajuste os filtros ou exporte o relatório para ver mais.', 'Showing the 8 most urgent follow-ups. Adjust filters or export the report to see more.', 'Mostrando los 8 seguimientos más urgentes. Ajusta los filtros o exporta el informe para ver más.', 'Affichage des 8 suivis les plus urgents. Ajustez les filtres ou exportez le rapport pour en voir plus.'),
  c('Ações em lote', 'Bulk actions', 'Acciones en lote', 'Actions groupées'),
  c('Responsável em lote', 'Bulk owner', 'Responsable en lote', 'Responsable groupé'),
  c('Prazo em lote', 'Bulk due date', 'Plazo en lote', 'Échéance groupée'),
  c('Escolha responsável', 'Choose owner', 'Elige responsable', 'Choisir un responsable'),
  c('Atribuir filtrados', 'Assign filtered', 'Asignar filtrados', 'Assigner les suivis filtrés'),
  c('Atualizar prazo', 'Update due date', 'Actualizar plazo', 'Mettre à jour l’échéance'),
  c('Marcar filtrados como concluídos', 'Mark filtered as done', 'Marcar filtrados como concluidos', 'Marquer les suivis filtrés comme terminés'),
  c('Não foi possível atualizar os acompanhamentos filtrados.', 'Could not update the filtered follow-ups.', 'No se pudieron actualizar los seguimientos filtrados.', 'Impossible de mettre à jour les suivis filtrés.'),
  c('Selecione um responsável para atribuir.', 'Select an owner to assign.', 'Selecciona un responsable para asignar.', 'Sélectionnez un responsable à assigner.'),
  c('Escolha um prazo para atualizar.', 'Choose a due date to update.', 'Elige un plazo para actualizar.', 'Choisissez une échéance à mettre à jour.'),
  c('Resolver chamados urgentes antes da próxima checagem do conselho.', 'Resolve urgent tickets before the next board check-in.', 'Resuelve tickets urgentes antes del próximo chequeo del consejo.', 'Résolvez les tickets urgents avant le prochain point du conseil.'),
  c('Escalar falhas de SLA do fornecedor e atualizar o responsável pela ordem.', 'Escalate vendor SLA misses and update the work-order owner.', 'Escala incumplimientos de SLA del proveedor y actualiza al responsable de la orden.', 'Escaladez les SLA prestataires manqués et mettez à jour le responsable de l’ordre.'),
  c('Agrupar problemas recorrentes em um plano com responsável e orçamento.', 'Group recurring problems into one work plan with owner and budget.', 'Agrupa problemas recurrentes en un plan con responsable y presupuesto.', 'Regroupez les problèmes récurrents dans un plan avec responsable et budget.'),
  c('Cobrar atualizações atrasadas do fornecedor e registrar próximos passos.', 'Chase stale vendor updates and log next steps.', 'Persigue actualizaciones pendientes del proveedor y registra próximos pasos.', 'Relancez les mises à jour prestataire en retard et consignez les prochaines étapes.'),
  c('Revisar cobranças em atraso e acompanhamento de pagamento.', 'Review overdue dues and payment follow-up.', 'Revisa cuotas vencidas y seguimiento de pagos.', 'Revoyez les charges en retard et le suivi de paiement.'),
  c('Revisar comprovantes de pagamento pendentes.', 'Review pending payment proofs.', 'Revisa comprobantes de pago pendientes.', 'Revoyez les justificatifs de paiement en attente.'),
  c('Aprovar ou rejeitar acessos pendentes de moradores.', 'Approve or reject pending resident access.', 'Aprueba o rechaza accesos pendientes de residentes.', 'Approuvez ou refusez les accès résidents en attente.'),
  c('Adicionar análise de orçamento antes de abrir votos.', 'Add budget analysis before opening proposal votes.', 'Agrega análisis de presupuesto antes de abrir votaciones.', 'Ajoutez l’analyse budgétaire avant d’ouvrir les votes.'),
  c('Manter o prédio em monitoramento semanal.', 'Keep the building on weekly monitoring.', 'Mantén el edificio en monitoreo semanal.', 'Gardez l’immeuble en suivi hebdomadaire.'),
  ...
  c('Sugerir', 'Suggest', 'Sugerir', 'Suggérer'),
  c('Tendência de 6 meses', '6-month trend', 'Tendencia de 6 meses', 'Tendance sur 6 mois'),
  c('Ritmo operacional', 'Operational pace', 'Ritmo operativo', 'Rythme opérationnel'),
  c('Visão por mês dos chamados, ordens e gasto de manutenção.', 'Monthly view of tickets, work orders, and maintenance spend.', 'Vista mensual de tickets, órdenes y gasto de mantenimiento.', 'Vue mensuelle des tickets, ordres de service et dépenses de maintenance.'),
  c('meses', 'months', 'meses', 'mois'),
  c('Sem histórico suficiente para tendência.', 'Not enough history for a trend yet.', 'Aún no hay histórico suficiente para la tendencia.', 'Pas assez d’historique pour une tendance.'),
  c('Ordens concluídas', 'Completed work orders', 'Órdenes completadas', 'Ordres terminés'),
  c('Gasto manutenção', 'Maintenance spend', 'Gasto mantenimiento', 'Dépenses maintenance'),
  c('História de obra', 'Work-order story', 'Historia de obra', 'Parcours de l’ordre'),
  c('Chamado até conclusão', 'Ticket to completion', 'Ticket hasta cierre', 'Du ticket à la clôture'),
  c('Mostra o caminho que uma administradora consegue explicar: chamado, cotação, agendamento e fechamento.', 'Shows the path a management company can explain: ticket, quote, scheduling, and closure.', 'Muestra el camino que una administradora puede explicar: ticket, cotización, agenda y cierre.', 'Montre le parcours qu’un gestionnaire peut expliquer : ticket, devis, planification et clôture.'),
  c('Nenhuma ordem de serviço ainda.', 'No work orders yet.', 'Aún no hay órdenes de servicio.', 'Aucun ordre de service pour le moment.'),
  c('Chamado aberto', 'Ticket opened', 'Ticket abierto', 'Ticket ouvert'),
  c('Fornecedor definido', 'Vendor selected', 'Proveedor definido', 'Prestataire défini'),
  c('Ordem agendada', 'Work order scheduled', 'Orden programada', 'Ordre planifié'),
  c('Comprovado', 'Verified', 'Comprobado', 'Vérifié'),
  c('Sem data', 'No date', 'Sin fecha', 'Sans date'),
  c('Sem valor', 'No amount', 'Sin valor', 'Sans montant'),
  c('Abrir chamados', 'Open tickets', 'Abrir tickets', 'Ouvrir les tickets'),
  c('cotação', 'quote', 'cotización', 'devis'),
  c('cotações', 'quotes', 'cotizaciones', 'devis'),
  ...
  c('Baixar PDF', 'Download PDF', 'Descargar PDF', 'Télécharger PDF'),
  c('Imprimir', 'Print', 'Imprimir', 'Imprimer'),
  c('Pacote copiado', 'Packet copied', 'Paquete copiado', 'Dossier copié'),
  c('Não foi possível baixar PDF', 'Could not download PDF', 'No se pudo descargar el PDF', 'Impossible de télécharger le PDF'),
  ...
  c('+ adicionar contexto (tipo, local, orçamento, urgência)', '+ add context (type, location, budget, urgency)', '+ agregar contexto (tipo, ubicación, presupuesto, urgencia)', '+ ajouter du contexte (type, lieu, budget, urgence)'),
  c('Gerar plano', 'Generate plan', 'Generar plan', 'Générer le plan'),
  c('30-60s, usa seu histórico do prédio', '30-60s, uses your building history', '30-60s, usa el historial del edificio', '30-60 s, utilise l’historique de l’immeuble'),
  ...
  c('Não foi possível atualizar', 'Could not update', 'No se pudo actualizar', 'Impossible de mettre à jour'),
  c('Pausar', 'Pause', 'Pausar', 'Mettre en pause'),
  c('Reativar', 'Reactivate', 'Reactivar', 'Réactiver'),
  ...
  c('Fila de despachos', 'Dispatch queue', 'Cola de despachos', 'File de dispatch'),
  c('worker(s) ativo(s)', 'active worker(s)', 'worker(s) activo(s)', 'worker(s) actif(s)'),
  c('ativos', 'active', 'activos', 'actifs'),
  c('Em fila', 'Queued', 'En cola', 'En file'),
  c('Em análise', 'In review', 'En análisis', 'En analyse'),
  c('Concluídos', 'Completed', 'Completados', 'Terminés'),
  c('Falhas (24h)', 'Failures (24h)', 'Fallos (24h)', 'Échecs (24h)'),
  c('falhas 24h', 'failures in 24h', 'fallos en 24h', 'échecs en 24 h'),
  c('Falhas recentes', 'Recent failures', 'Fallos recientes', 'Échecs récents'),
  c('Falhas recentes — confira os chamados afetados', 'Recent failures — check the affected tickets', 'Fallos recientes — revisa los tickets afectados', 'Échecs récents — vérifiez les tickets concernés'),
  c('Fila com atraso — worker pode estar travado', 'Queue is delayed — a worker may be stuck', 'Cola con retraso — un worker puede estar trabado', 'File en retard — un worker est peut-être bloqué'),
  c('Análise em andamento há muito tempo', 'Analysis has been running too long', 'El análisis lleva demasiado tiempo en curso', 'L’analyse est en cours depuis trop longtemps'),
  c('sem detalhes', 'no details', 'sin detalles', 'sans détails'),
  ...
  c('Custo: pedir orçamento', 'Cost: request a quote', 'Costo: pedir cotización', 'Coût : demander un devis'),
  ...
  c('Notificações bloqueadas', 'Notifications blocked', 'Notificaciones bloqueadas', 'Notifications bloquées'),
  c('Notificações ativadas', 'Notifications enabled', 'Notificaciones activadas', 'Notifications activées'),
  c('Buscar unidade, morador, visitante, encomenda ou festa', 'Search unit, resident, visitor, package, or party', 'Busca unidad, residente, visitante, paquete o fiesta', 'Rechercher lot, résident, visiteur, colis ou fête'),
  c('Buscar fila da portaria', 'Search front desk queue', 'Buscar en la fila de portería', 'Rechercher dans la file conciergerie'),
