...
const phrases: Copy[] = [
  ...
  c('Não foi possível concluir os acompanhamentos filtrados.', 'Could not complete the filtered follow-ups.', 'No se pudieron completar los seguimientos filtrados.', 'Impossible de terminer les suivis filtrés.'),
