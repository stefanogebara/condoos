...
const phrases: Copy[] = [
  ...
  c('Cada contato salvo precisa ter empresa e pelo menos uma forma de contato ou observação. Links devem começar com http:// ou https://.', 'Each saved contact needs a company and at least one contact channel or note. Links must start with http:// or https://.', 'Cada contacto guardado necesita una empresa y al menos un canal de contacto o nota. Los enlaces deben empezar con http:// o https://.', 'Chaque contact enregistré doit avoir une entreprise et au moins un canal de contact ou une note. Les liens doivent commencer par http:// ou https://.'),
  c('Criar prédio', 'Create building', 'Crear edificio', 'Créer l’immeuble'),
