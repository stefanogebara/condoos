          ...
          <GlassCard key={a.id} variant={a.pinned ? 'clay-peach' : 'clay'} className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <h3 data-user-content className="font-display text-lg text-dusk-500 mt-1">{t(a.title)}</h3>
                <p data-user-content className="text-sm text-dusk-400 mt-1 whitespace-pre-line">{t(a.body)}</p>
              </div>
            </div>
          </GlassCard>
        ))}
