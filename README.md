...
- **Maintenance lifecycle** — ticket events, vendor quotes, quote decisions, recurring problem detection, SLA alerts, work orders, and resident-safe progress history.
- **Agency command center** — richer multi-building priorities, vendor follow-up health, pilot readiness, permission review, invite delivery, monthly reports, and packaged export packs.
